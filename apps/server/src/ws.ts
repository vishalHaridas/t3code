...
import { runNotebookTurnStream } from "./notebook/NotebookTurnService.ts";
...
const RPC_REQUIRED_SCOPE = new Map<string, AuthEnvironmentScope>([
  ...
  [ORCHESTRATION_WS_METHODS.notebookTurn, AuthOrchestrationOperateScope],
      ...
      return WsRpcGroup.of({
        ...
        [ORCHESTRATION_WS_METHODS.notebookTurn]: (input) =>
          observeRpcStreamEffect(
            ...
            runNotebookTurnStream(providerService, input),
            { "rpc.aggregate": "orchestration" },
          ),
